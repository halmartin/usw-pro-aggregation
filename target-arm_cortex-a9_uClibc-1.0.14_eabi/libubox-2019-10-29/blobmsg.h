...
static inline int
blobmsg_add_s8(struct blob_buf *buf, const char *name, int8_t val)
{
	return blobmsg_add_field(buf, BLOBMSG_TYPE_INT8, name, &val, 1);
}

static inline int
blobmsg_add_s16(struct blob_buf *buf, const char *name, int16_t val)
{
	val = cpu_to_be16(val);
	return blobmsg_add_field(buf, BLOBMSG_TYPE_INT16, name, &val, 2);
}
...
static inline int
blobmsg_add_s32(struct blob_buf *buf, const char *name, int32_t val)
{
	val = cpu_to_be32(val);
	return blobmsg_add_field(buf, BLOBMSG_TYPE_INT32, name, &val, 4);
}
...
static inline int
blobmsg_add_s64(struct blob_buf *buf, const char *name, int64_t val)
{
	val = cpu_to_be64(val);
	return blobmsg_add_field(buf, BLOBMSG_TYPE_INT64, name, &val, 8);
}
...
static inline int8_t blobmsg_get_s8(struct blob_attr *attr)
{
	return *(int8_t *) blobmsg_data(attr);
}
...
static inline int16_t blobmsg_get_s16(struct blob_attr *attr)
{
	return be16_to_cpu(*(int16_t *) blobmsg_data(attr));
}

static inline int32_t blobmsg_get_s32(struct blob_attr *attr)
{
	return be32_to_cpu(*(int32_t *) blobmsg_data(attr));
}

static inline int64_t blobmsg_get_s64(struct blob_attr *attr)
{
	union {
		int64_t s64;
		uint64_t u64;
